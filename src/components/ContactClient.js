  ...
  return (
    <div className="bg-[var(--background)] text-[var(--foreground)] overflow-y-scroll overflow-x-hidden py-8 sm:py-8 md:py-10 lg:py-12 px-4 sm:px-6 md:px-10 lg:px-[30px] pb-24 sm:pb-28 md:pb-20 lg:pb-12 relative" style={{ minHeight: '100vh', height: '100%', scrollbarWidth: 'thin', scrollbarColor: 'var(--nav-text) var(--background)', '--tw-screen-xs': '480px' }}>
      <div className="absolute inset-0 flex items-start justify-center pointer-events-none overflow-hidden">
        <h1 className="text-[var(--card-bg)] text-5xl sm:text-5xl md:text-[5.5rem] lg:text-[6rem] xl:text-[7rem] font-extrabold tracking-tighter select-none pt-11 md:pt-14 lg:pt-8">CONTACT</h1>
      </div>
    
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-6 sm:mb-8 md:mb-10 text-center relative z-10 mt-4 md:mt-8 lg:mt-10">
        <motion.h1 initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-3 sm:mb-4 md:mb-6">
        ...
        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="space-y-6 sm:space-y-7 md:space-y-8 pr-0 md:pr-4 lg:pr-6">
          ...
          <div className="flex items-center space-x-2 xs:space-x-3 sm:space-x-4 md:space-x-5 mt-4 sm:mt-6 md:mt-8">
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Link href="https://www.facebook.com/share/1D4Evsgexx/" target="_blank" rel="noopener noreferrer" className="bg-[var(--card-bg)] p-1.5 xs:p-2 sm:p-2.5 md:p-3 rounded-full hover:bg-[var(--primary)] active:bg-[var(--primary)] active:scale-95 transition-all duration-300 inline-block">
            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Link href="https://x.com/irfan_arshad8?t=jRbuKdlS7YpbCBiv8dgIZQ&s=08" target="_blank" rel="noopener noreferrer" className="bg-[var(--card-bg)] p-1.5 xs:p-2 sm:p-2.5 md:p-3 rounded-full hover:bg-[var(--primary)] active:bg-[var(--primary)] active:scale-95 transition-all duration-300 inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 xs:h-3.5 xs:w-3.5 sm:h-4 sm:w-4 md:h-5 md:w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Link href="https://www.instagram.com/irfan.arshed.77?igsh=OG9kZTRwcDUzOXNu" target="_blank" rel="noopener noreferrer" className="bg-[var(--card-bg)] p-1.5 xs:p-2 sm:p-2.5 md:p-3 rounded-full hover:bg-[var(--primary)] active:bg-[var(--primary)] active:scale-95 transition-all duration-300 inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 xs:h-3.5 xs:w-3.5 sm:h-4 sm:w-4 md:h-5 md:w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Link href="https://www.linkedin.com/in/c%D4%8B-%CE%B9%C9%BE%CF%9D%CE%B1%C9%B3-a%C9%BE%CA%82%D4%8B%CE%B1%D4%83-78320435b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="bg-[var(--card-bg)] p-1.5 xs:p-2 sm:p-2.5 md:p-3 rounded-full hover:bg-[var(--primary)] active:bg-[var(--primary)] active:scale-95 transition-all duration-300 inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 xs:h-3.5 xs:w-3.5 sm:h-4 sm:w-4 md:h-5 md:w-5" fill="currentColor" viewBox="0 0 24 24">
