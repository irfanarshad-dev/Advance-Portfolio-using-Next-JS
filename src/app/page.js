...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col w-full lg:w-1/2 items-center relative lg:justify-center pt-6 sm:pt-8 md:pt-4 lg:pt-0 pb-0 lg:pb-0"
        style={{ minHeight: "30vh", height: "auto", minHeight: "calc(50vh - 40px)" }}
      >
        ...
        <div
          className={`
            ...
            w-40 h-40 sm:w-60 sm:h-60 md:w-[350px] md:h-[350px] lg:w-[600px] lg:h-[calc(100vh-80px)] xl:w-[650px]
            overflow-hidden
            shadow-lg
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start lg:justify-center justify-start py-2 sm:p-6 md:p-8 lg:p-8 mt-0 sm:mt-10 md:mt-6 lg:mt-0">
         <div className="text-center lg:text-left space-y-4 sm:space-y-5 md:space-y-6 sm:px-4 md:px-10 lg:px-12 max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-lg lg:mx-0 w-full">
          ...
          >
            ...
            {/* Animated yellow background - works on both hover and touch */}
            <span
        ...
        {showAboutModal && (
          ...
          >
            ...
            >
              ...
              <button 
                onClick={toggleAboutModal}
                className="absolute top-4 right-3 sm:top-4 sm:right-4 z-50 w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full bg-[var(--primary)] flex items-center justify-center text-[var(--background)] hover:bg-[var(--primary-hover)] transition-colors"
              >
